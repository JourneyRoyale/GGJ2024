...
# Polls all audience members when a joke is told in order to determine current laughter score.
func poll_audience(audienceMembers_humored):
	laughter = clamp(laughter + audienceMembers_humored * laughter_factor,0,2);
